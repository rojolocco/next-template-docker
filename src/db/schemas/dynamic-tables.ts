import { pgTable, text, integer, boolean, timestamp, varchar, decimal } from 'drizzle-orm/pg-core';
import { sql } from 'drizzle-orm';

// This is a utility function to create dynamic table schemas
export function createDynamicTableSchema(tableName: string, columns: Array<{
    name: string;
