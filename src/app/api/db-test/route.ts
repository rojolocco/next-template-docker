...
export async function GET() {
    try {
        ...
        const testQuery = await client`SELECT NOW() as current_time, 'Connection successful!' as message`;
        ...
        return NextResponse.json({
            ...
            troubleshooting: {
                ...
                checkPort: 'Verify port 5432 is accessible: docker port <container_name>',
                checkEnv: 'Verify DATABASE_URL in .env.local matches your Docker setup',
                commonIssues: [
